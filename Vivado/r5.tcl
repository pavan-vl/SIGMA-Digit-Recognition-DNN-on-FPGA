...
################################################################
# This is a generated script based on design: r5
#
...
xilinx.com:MNSIT_DNN_Digit_Recognition:DNN_Digit_Recog_Sig5:1.0\
"
...
proc create_root_design { parentCell } {
  ...
  # Create instance: DNN_Digit_Recog_Sig5_0, and set properties
  set DNN_Digit_Recog_Sig5_0 [ create_bd_cell -type ip -vlnv xilinx.com:MNSIT_DNN_Digit_Recognition:DNN_Digit_Recog_Sig5:1.0 DNN_Digit_Recog_Sig5_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins DNN_Digit_Recog_Sig5_0/S00_AXIS] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins DNN_Digit_Recog_Sig5_0/S00_AXI] [get_bd_intf_pins axi_smc/M01_AXI]
  ...
  [get_bd_pins DNN_Digit_Recog_Sig5_0/s00_axi_aclk] \
  [get_bd_pins DNN_Digit_Recog_Sig5_0/s00_axis_aclk]
  ...
  [get_bd_pins DNN_Digit_Recog_Sig5_0/s00_axis_aresetn] \
  [get_bd_pins DNN_Digit_Recog_Sig5_0/s00_axi_aresetn]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces S00_AXI] [get_bd_addr_segs DNN_Digit_Recog_Sig5_0/S00_AXI/S00_AXI_reg] -force
