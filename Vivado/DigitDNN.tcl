...
################################################################
# This is a generated script based on design: DigitDNN
#
...
##################################################################
set bCheckSources 1
set list_bdc_active "r10"
set list_bdc_dfx "r5, r8"
...
# Hierarchical cell: sr
proc create_hier_cell_sr { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_sr() - Empty argument(s)!"}
     return
  }
...
\
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins S00_AXI] [get_bd_intf_pins axi_mem_intercon/S00_AXI]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_pins rgb_led] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_mem_intercon_M00_AXI [get_bd_intf_pins axi_mem_intercon/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net axi_smc_1_M00_AXI [get_bd_intf_pins axi_smc_1/M00_AXI] [get_bd_intf_pins axi_gpio_0/S_AXI]
  connect_bd_intf_net -intf_net axi_smc_1_M01_AXI [get_bd_intf_pins axi_smc_1/M01_AXI] [get_bd_intf_pins axi_timer_0/S_AXI]
  ...
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn  [get_bd_pins S00_ARESETN] \
  ...
  connect_bd_net -net xlconcat_0_dout  [get_bd_pins IRQ_F2P] \
...
proc create_root_design { parentCell } {
  ...
  # Create instance: sr
  create_hier_cell_sr [current_bd_instance .] sr

  # Create instance: rp, and set properties
  set rp [ create_bd_cell -type container -reference r10 rp ]
  set_property -dict [list \
    CONFIG.ACTIVE_SIM_BD {r10.bd} \
    CONFIG.ACTIVE_SYNTH_BD {r10.bd} \
    CONFIG.ENABLE_DFX {true} \
    CONFIG.LIST_SIM_BD {r10.bd:r8.bd:r5.bd} \
    CONFIG.LIST_SYNTH_BD {r10.bd:r8.bd:r5.bd} \
    CONFIG.LOCK_PROPAGATE {true} \
  ] $rp


  set_property SELECTED_SIM_MODEL rtl  $rp

  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins rp/M_AXI_MM2S] [get_bd_intf_pins sr/S00_AXI]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports rgb_led] [get_bd_intf_pins sr/rgb_led]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins sr/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins sr/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins sr/M_AXI_GP0] [get_bd_intf_pins rp/S00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0  [get_bd_pins sr/FCLK_CLK0] \
  [get_bd_pins rp/s_axi_lite_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N  [get_bd_pins sr/ext_reset_in] \
  [get_bd_pins rp/ext_reset_in]
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn  [get_bd_pins rp/peripheral_aresetn] \
  [get_bd_pins sr/S00_ARESETN]
  connect_bd_net -net xlconcat_0_dout  [get_bd_pins rp/dout] \
  [get_bd_pins sr/IRQ_F2P]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces rp/axi_dma_0/Data_MM2S] [get_bd_addr_segs sr/processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces sr/processing_system7_0/Data] [get_bd_addr_segs rp/DNN_Digit_Recog_Sig10_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces sr/processing_system7_0/Data] [get_bd_addr_segs rp/axi_dma_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x81200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces sr/processing_system7_0/Data] [get_bd_addr_segs sr/axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x82800000 -range 0x00010000 -target_address_space [get_bd_addr_spaces sr/processing_system7_0/Data] [get_bd_addr_segs sr/axi_timer_0/S_AXI/Reg] -force
